...
puts tableau.sort {|tableaumaj,tableaumin| tableaumaj.casecmp(tableaumin)}
puts " "

puts "Question 6 : Trie la liste de handle par taille des handle (les plus petits en premiers, les plus grands après)"
puts tableau.sort_by {|tableau| tableau.length}
